 ...
 */
final class Version20231119140307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_to_book_format (id INT NOT NULL, book_id INT NOT NULL, book_format_id INT NOT NULL, price NUMERIC(10, 2) DEFAULT NULL, discount_percent INT DEFAULT NULL, PRIMARY KEY(id))');
